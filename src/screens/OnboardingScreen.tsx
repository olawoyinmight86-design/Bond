...
export default function OnboardingScreen() {
  ...
  return (
    <div className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-ink-50 via-surface to-brand-50/30 px-6">
